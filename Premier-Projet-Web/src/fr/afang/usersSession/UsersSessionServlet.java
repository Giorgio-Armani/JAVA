...
/**
 * Servlet implementation class UsersSessionServlet
 */
@WebServlet("/UsersSessionServlet")
public class UsersSessionServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		session.setAttribute("personnes", p);
		
		
		this.getServletContext().getRequestDispatcher("/WEB-INF/usersSession.jsp").forward(request,response);
