...
<div id="div-alimentaires">
    <fieldset>
    <c:forEach items="${tabProduitsAlimentaires}" var="produit">
        <div class="produit">
            <p class="prix">${produit.prix}</p>
           <a href="DetailsProduitServlet?url=${produit.url}&nom=${produit.nom}&prix=${produit.prix}"><img src="${produit.url }" alt="${produit.nom }" title="${produit.nom }"></a>
